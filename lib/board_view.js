...
class BoardView {
  ...
  // _removeMovementKeyPress(key) {
  //   if (key === KEY_LEFT || key === KEY_RIGHT) {
  //     if (this.horizontalKeys[0] === key) {
  //       this.horizontalKeys.shift();
  //     } else if (this.horizontalKeys[1] === key) {
  //       this.horizontalKeys.pop();
  //     }
  //   } else if (key === KEY_UP || key === KEY_DOWN) {
  //     if (this.verticalKeys[0] === key) {
  //       this.verticalKeys.shift();
  //     } else if (this.verticalKeys[1] === key) {
  //       this.verticalKeys.pop();
  //     }
  //   }
  // }
